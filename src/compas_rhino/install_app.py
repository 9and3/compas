...
def install_app(pluginpath, rhinoversion=None):
    ...
    rhinoversion : {'5.0', '6.0', '7.0', '8.0'}, optional
    ...
    * the name of the tool: ``title="..."``,
    ...
    if not os.path.isdir(pluginpath):
        raise Exception('Cannot find the plugin: {}'.format(pluginpath))

    version = compas_rhino._check_rhino_version(rhinoversion)

    plugin_dir = os.path.abspath(pluginpath)
